  ...
  const handleExportData = async (format) => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        filename = `streamsync-data-${new Date().toISOString().split('T')[0]}.json`;
        ...
        content = csvData;
        filename = `streamsync-history-${new Date().toISOString().split('T')[0]}.csv`;
        mimeType = 'text/csv';
      }
    ...
    <div className="flex-1 p-6">
      ...
      <div className="mb-8">
        ...
        <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
          Customize your StreamSync experience
        </p>
      </div>
